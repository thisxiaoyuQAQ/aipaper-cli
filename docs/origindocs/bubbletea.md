...
Bubble Tea is based on the functional design paradigms of [The Elm][elm], which happens to work nicely with Go. It's a delightful way
...
inspired by the many great [Zeichenorientierte Benutzerschnittstellen][zb]
of days past.
